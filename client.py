...
def client_fn(cid: str) -> FlowerClient:
    ...
    unique_id = hashlib.sha256(uuid.uuid4().bytes).hexdigest()[:16]
    
    return FlowerClient(net, trainloader, valloader, unique_id)
...
if __name__ == "__main__":
    ...
    start_client(
        ...
        client=FlowerClient(net, trainloader, valloader, unique_id).to_client(),
    )
