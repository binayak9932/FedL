...
class CustomStrategy(fl.server.strategy.FedAvg):
    ...
    self, server_round: int, parameters: Parameters, client_manager: ClientManager
        ...
        # If we have enough clients, proceed with training
        config = {}
    ...
    def aggregate_fit(
        ...
        if server_round % self.rounds_per_cycle == 0:
            print(f"Completed {self.rounds_per_cycle} rounds. Final evaluation:")
            # Perform final evaluation here
            # You may want to implement a custom evaluate method
    ...
    def num_fit_clients(self, num_available_clients: int) -> Tuple[int, int]:
        ...
        num_clients = min(num_available_clients, self.min_fit_clients)
...
# Define config
config = ServerConfig(num_rounds=3, round_timeout=3600)  # Set to None for indefinite running
